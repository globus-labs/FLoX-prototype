...
class FloxConsoleFormatter(logging.Formatter):
    """
...
def _get_file_dict_config(
    ...
    return {
        ...
        "formatters": {
            "streamfmt": {
                "()": "flox.common.logging_config.FloxConsoleFormatter",
                "debug": debug,
                "no_color": no_color,
            },
            "filefmt": {
...
class FloxLogger(logging.Logger):
    TRACE = logging.DEBUG - 5

    def trace(self, msg, *args, **kwargs):
        self.log(FloxLogger.TRACE, msg, args, **kwargs)


logging.setLoggerClass(FloxLogger)
